...
export default function Header() {
  return (
    <header className="relative mx-4 md:mx-8 mt-2 md:mt-4 rounded-full bg-background/30 px-4 md:px-8 h-14 md:h-18 border-t border-border backdrop-blur-3xl flex-center-between z-50 max-w-7xl xl:mx-auto">
